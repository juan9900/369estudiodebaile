    ...
    <div className="space-y-6">
      ...
      {paymentMethod === "efectivo" && (
        <div className="rounded-lg border bg-white p-4">
          <p className="text-sm font-bold uppercase text-textColor mb-1">Pago en persona</p>
          <p className="text-textColor text-sm">
            Puedes pagar el monto completo en efectivo acercándote al estudio al menos 3 días antes de la clase.
          </p>
        </div>
      )}
